...
import {childrenOf, createShallowRenderer, predicateByType} from '../helpers/shallowHelpers';
...
describe('elementsMatching', () => {
  ...
  it('finds multiple direct children', () => {
    ...
    expect(elementsMatching(predicateByType('p'))).toEqual([<p>A</p>, <p>B</p>]);
  });
...
describe('elementMatching', () => {
  ...
  it('finds first direct child', () => {
    ...
    expect(elementMatching(predicateByType('p'))).toEqual(<p>A</p>);
  });
});
